                    ...
                    <table class="table border table-responsive-lg">
                        <thead>
                            <tr>
                                ...
                                <th style="min-width: 100px">{{ __('Shop / Individual') }}</th>
                        ...
                        @forelse($products as $key => $product)
                            <tr>
                                ...
                                <td>
                                    @if ($product->shop->user->is_individual)
                                    <a class="text-decoration-none text-dark"
                                        href="{{ route('admin.individual.show', $product->shop_id) }}">
                                        {{ $product->shop->user->name }} {{ $product->shop->user->last_name }}
                                    </a>
                                    @else
                                        <a class="text-decoration-none text-dark"
