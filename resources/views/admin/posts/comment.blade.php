...
@section('content')
    ...
    <form action="{{ route('admin.posts.addComment', ['id' => $post_id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card mt-3">
            <div class="card-body">
               ...
               Post Id: {{$post_id}}
                ...
                <div class="mt-3">
                    ...
                    <textarea required name="comment" class="form-control @error('comment') is-invalid @enderror"
                        rows="2" placeholder="Enter Comment">{{ old('comment') }}</textarea>
                    @error('comment')
        ...
        <div class="d-flex gap-3 justify-content-end align-items-center mt-3">
