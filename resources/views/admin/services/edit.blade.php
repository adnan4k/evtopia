...
@section('content')
    <div class="page-title">
        <div class="d-flex gap-2 align-items-center">
            <i class="fa-solid fa-shop"></i> {{__('Edit Service')}}
        </div>
    </div>
    <form action="{{ route('admin.service.update', $service->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card mt-3">
            <div class="card-body">
                ...
                <div class="">
                    <x-input label="Service Name" name="name" type="text" placeholder="Service Name"
                        required="true" value="{{ $service->name }}" />
                </div>
                ...
                <div class="mt-3">
                    ...
                    <textarea name="short_description" class="form-control" rows="2" placeholder="Short Description">{{ old('short_description') ?? $service->short_description }}</textarea>
                </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <x-input type="text" name="price" label=" Price" placeholder=" Price"
                            required="true" onlyNumber="true" :value="$service->price" />
                    </div>

                    <div class="col-lg-4 col-md-6 mt-3 mt-md-0">
                        <x-input type="text" name="discounted_price" label="Discount Price"
                            placeholder="Discount Price" onlyNumber="true" :value="$service->discounted_price" />
                    </div>


                    <div class="col-lg-4 col-md-6 mt-3 mt-md-0">
                        <x-input type="text" name="duration" label="Duration"
                            placeholder="Duration" onlyNumber="true" :value="$service->duration" />
                    </div>
            ...
            <div class="col-md-5 col-xl-3">
                <div class="card card-body h-100">
                    ...
                    <label for="thumbnail" class="additionThumbnail">
                        <img src="{{ $service->thumbnail ?? asset('defualt/upload.png') }}" id="preview"
                            alt="" width="100%">
                    </label>
                            ...
                            @foreach ($service->medias as $media)
                                ...
                                <div id="additionShow">
                                    <label for="previousThumbnailShow{{ $media->id }}" class="additionThumbnail">
                                        ...
                                        <a href="{{ route('shop.product.remove.thumbnail', ['product' => $service->id, 'media' => $media->id]) }}"
