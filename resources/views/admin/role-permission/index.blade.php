                ...
                <div class="col-lg-6 h-100">
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-3 justify-content-between mt-3">
                        <div class="position-relative flex-grow-1">
                            <input type="text" class="form-control py-2.5" placeholder="Search by role name" id="search"
                                onkeyup="filterRoles()">
                        ...
                        @foreach ($roles as $role)
                            <button type="button"
                                ...
                                <a href="{{ route('admin.role.permission', $role->id) }}" class="p-2 linkBtn flex-grow-1">
                                    {{ $role->name }} ({{ $role->name != 'root' ? count($role->permissions) : 'All' }}) @if ($role->is_shop)
                                ...
                                @else
                                    <span class="badge bg-secondary fst-italic">No Action</span>
                                @endif
                            </button>
                        @endforeach
                    </div>
                                ...
                                <div class="d-flex flex-column gap-3 mt-3">
                                    ...
                                    @foreach ($allPermissionArray as $adminType => $allPermissions)
                                        ...
                                        @foreach ($allPermissions as $permissionName => $permissionValues)
                                            <div>
                                                <p class="text-capitalize m-0 fz-20 pb-1">
                                                    ...
                                                    <div class="fz-18 d-flex align-items-center flex-wrap gap-3">
                                                        @foreach ($permissionValues as $permission)
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <label class="m-0"> {{ permissionName($permission) }}
                                                                </label>
                                                            </div>
                                                        @endforeach
                                                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex align-items-center mt-3">
                        ...
                        <input type="checkbox" class="form-check-input ms-2 mb-0" id="forShop" name="for_shop" checked />
                    </div>
                </div>
