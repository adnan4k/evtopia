...
@section('content')
    ...
    <form action="{{ route('admin.post_categories.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <div class="mt-5 d-flex gap-2 justify-content-between">
                            <a href="{{ route('admin.post_categories.index')}}" class="btn btn-secondary py-2 px-4">
                            {{__('Back')}}
                            </a>
