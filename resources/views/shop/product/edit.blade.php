        ...
        <div class="card mt-4">
            <div class="card-body">
                ...
                <div class="row mt-3">
                        ...
                        <x-select label="Select Drive Train" name="drive_train" placeholder="Select Drive Train">
                            ...
                            @foreach ($driveTrains as $driveTrain)
                                <option value="{{ $driveTrain->id }}"
                                    {{ $driveTrain->id == $product->drive_train_id ? 'selected' : '' }}
                    ...
                    <div class="col-lg-4 col-md-6  mt-3 ">
                        <x-select label="Select Transmission" name="transmission" placeholder="Select Transmission">
                            <option value="">
                                {{ __('Select Transmission') }}
                            </option>
                            @foreach ($transmissions as $transmission)
                                <option value="{{ $transmission->id }}"
                                    {{ $transmission->id == $product->car_transmission_id ? 'selected' : '' }}
                    ...
                    <div class="col-lg-4 col-md-6  mt-3  ">
                        ...
                        <input type="number" id="year" name="year" value="{{$product->year}}" placeholder="Ex: 2022" class="form-control"
                    ...
                    <div class="col-lg-4 col-md-6  mt-3 ">
                        ...
                        <input type="number" id="kilometer" name="kilometer" placeholder="Ex: 100" class="form-control"
                    ...
                    <div class="col-lg-4 col-md-6  mt-3 ">
                        ...
                        <input type="text" id="model" value="{{$product->model}}" name="model" placeholder="M0012" class="form-control"
                    ...
                    <div class="col-md-6 col-lg-4 mt-3 d-flex align-items-end">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="1" id="is_special"
                                name="is_special" {{ auth()->user()->is_individual || $product->is_special ? ' checked' : ''}}
                                
                                {{ auth()->user()->is_individual ? ' disabled' : ''}}>
                            <label class="form-check-label " style="font-size: 16px" for="is_special">
                                {{ __('I want to make it Special Offer') }}
                            </label>
                        </div>
                    </div>
                    {{-- @endif   --}}
