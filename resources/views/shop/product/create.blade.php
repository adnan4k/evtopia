            ...
            <div class="card-body">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-4 col-md-6  mt-3 ">
                        ...
                        <input type="text" id="model" name="model" placeholder="M00123" class="form-control"
                            value="{{ old('model') }}"
                            />
                        @error('model')
                            <p class="text text-danger m-0">{{ $message }}</p>
                    ...
                    {{-- Add checkbox attribute if want to make it special offer product --}}
                    {{-- @if(auth()->user()->is_individual) --}}
                    {{-- make it special and if its is_individual --}}
                    <div class="col-md-6 col-lg-4 mt-3 d-flex align-items-end">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="1" id="is_special"
                                name="is_special"   {{ auth()->user()->is_individual ? 'disabled checked' : ''}}>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-3 col-md-6 mt-3 mt-md-0">
                        <x-input type="text" name="discount_price" label="Discount Price"
                            placeholder="Discounted Price" onlyNumber="true" value="0" />
                    </div>
