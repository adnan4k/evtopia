...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="registerFormSection ps-3 pe-3 pe-md-0 py-4">
            ...
            <a class="text-decoration-none" style="color:gray; margin-top:-20px; font-weight: 600; font-size: 14px; font-style:italic;" href="/">
                <i class="fa-solid fa-arrow-left pe-2"></i> 
                Back To Home
                </a>
            <div class="d-flex flex-column" style="row-gap: 40px; margin-top: -30px">
                <div class="d-flex justify-content-between align-items-center pe-md-4 pb-2 border-bottom">
                    <h3 class="mb-0" style="font-weight: 600">
                        </i> {{ __('Register as Individual Seller') }}
                    </h3>
                ...
                <div class="pe-md-4">
                    <form action="{{ route('shop.register_individual.submit') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="step" id="step1">
                            <div style="display: flex; flex-direction: column; row-gap: 24px">
                                ...
                                <div class="information">
                                    ...
                                    <x-input type="hidden" name="is_individual"  value="1" label="Is Individual"
                                      />
                                    <div class="row">
                                        <div class="col-md-12">
