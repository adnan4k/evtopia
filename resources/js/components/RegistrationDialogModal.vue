<template>
    <div>
        ...
        <TransitionRoot as="template" :show="registerDilog">
            <Dialog as="div" class="relative z-10" @close="closeRegisterDilog()">
                            ...
                            <DialogPanel
                                ...
                                <div class="bg-white p-5 sm:p-8 relative">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <div class="flex">
                                                    <span
                                                        ...
                                                        +{{ registerFormData.phone_code || '251' }}
                                                    </span>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="relative">
                                            <input type="text"
                                                v-model="registerFormData.make" placeholder="Enter Manufacturer"
                                                class="text-base font-normal w-full p-3 placeholder:text-slate-400 rounded-lg border  focus:border-primary outline-none"
                                                :class="registerErrors?.make ? 'border-red-500' : 'border-slate-200'">
                                        </div>
                                        <span v-if="registerErrors && registerErrors?.make"
                                            class="text-red-500 text-sm">
                                            {{ registerErrors?.make[0] }}
                                        </span>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 gap-2 md:grid-cols-2">
                                        <div class="mt-4 ">
                                            ...
                                            <div class="relative">
                                                <input type="text"
                                                    v-model="registerFormData.model" placeholder="Enter Model"
                                                    class="text-base font-normal w-full p-3 placeholder:text-slate-400 rounded-lg border  focus:border-primary outline-none"
                                                    :class="registerErrors?.model ? 'border-red-500' : 'border-slate-200'">

                                            </div>
                                            <span v-if="registerErrors && registerErrors?.model"
                                                class="text-red-500 text-sm">
                                                {{ registerErrors?.model[0] }}
                                            </span>
                                        </div>
                                        ...
                                        <div class="mt-4 ">
                                            ...
                                            <div class="relative">
                                                <input type="number"
                                                    v-model="registerFormData.year" placeholder="Enter year"
                                                    class="text-base font-normal w-full p-3 placeholder:text-slate-400 rounded-lg border  focus:border-primary outline-none"
                                                    :class="registerErrors?.year ? 'border-red-500' : 'border-slate-200'">

                                            </div>
                                            <span v-if="registerErrors && registerErrors?.year"
                                                class="text-red-500 text-sm">
                                                {{ registerErrors?.year[0] }}
                                            </span>
                                        </div>
...
const emits = defineEmits(['hideRegisterDilog', 'showLogin']);
...
const closeRegisterDilog = () => {
    emits('hideRegisterDilog')
}
