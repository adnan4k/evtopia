<template>
    <div class="main-container mt- mb-12">

        <div class="flex justify-between items-center gap-4 flex-wrap">
            <!-- <div class="text-slate-950 text-lg  md:text-3xl font-bold leading-9">{{ $t('Brands') }}</div> -->
            ...
            <!-- <div class="flex justify-center items-center gap-4">
                ...
                <router-link to="/brands" class="text-slate-600 text-base font-normal leading-normal">
                    {{ $t('View All') }}
                </router-link>
