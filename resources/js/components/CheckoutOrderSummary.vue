    ...
    <div>
        <div class="p-6 bg-white rounded-2xl border border-slate-200">
            ...
            <div class="my-4 flex justify-between gap-4">
                ...
                <div class="text-slate-950 text-base font-normal leading-normal">
                    {{ master.showCurrency(serviceStore.total_amount) }}
                </div>
            </div>
            ...
            <div class="my-4 flex justify-between gap-4">
                ...
                <div class="text-slate-950 text-base font-normal leading-normal">
                    {{ master.showCurrency(basketStore.total_amount + serviceStore.total_amount) }}
                </div>
            </div>
            ...
            <div class="my-4 flex justify-between gap-4">
                ...
                <div class="text-slate-950 text-base font-normal leading-normal">
                    {{ master.showCurrency((basketStore.total_amount + serviceStore.total_amount - basketStore.coupon_discount).toFixed(2)) }}
                </div>
            </div>
            ...
            <div class="my-4 flex justify-between gap-4">
                ...
                <div class="text-slate-950 text-lg font-medium leading-normal tracking-tight">
                    {{ master.showCurrency(basketStore.total_amount + serviceStore.total_amount + basketStore.delivery_charge - basketStore.coupon_discount) }}
                </div>
            </div>
...
const processOrderConfirm = () => {
    ...
    if (  basketStore.checkoutProducts.length + serviceStore.total > 0) {
