            ...
            <div class="w-full p-2">
                <div v-if="props.product?.quantity > 0" class="justify-start items-center gap-3 flex w-full">
                    ...
                    <button
                        ...
                        <div class="text-primary text-sm font-normal flex justify-between gap-2 leading-tight">
                            <span>{{ $t('Detail') }}</span>
...
import { HeartIcon as HeartIconOutline, EyeIcon, ArrowRightIcon } from '@heroicons/vue/24/outline';
