<template>
    <div class="space-y-4">
        ...
        <div v-for="service in serviceStore.services" :key="service.id" class="border border-slate-100 rounded-xl">
<!-- 
            
            <div  class="p-4 rounded-t-xl justify-between items-center gap-4 flex "
              >
            ...
            <div class="p-4 flex flex-col gap-3">
                <div  :key="service.id">
                    <BasketServiceItem :product="service" />
                </div>
            </div>
...
import BasketServiceItem from './BasketServiceItem.vue';
