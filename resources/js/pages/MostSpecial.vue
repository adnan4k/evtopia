<template>
    <div class="main-container pt-8 pb-12">
        ...
        <div class="text-slate-800 text-lg lg:text-3xl font-bold">{{ $t(' Popular Products') }}</div>

        <!-- Products -->
        <div class="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 xxl:grid-cols-4  gap-3 sm:gap-6 items-start mt-6">
