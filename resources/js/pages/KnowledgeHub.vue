<template>
  ...
  :style="{ backgroundImage: `url(${banner})`, backgroundSize: 'cover', backgroundPosition: 'center' }">
        <h1 class="text-white text-3xl sm:text-4xl font-bold text-center">Our Knowledge Hub</h1>
    </div>
...
import BlogCard from '../components/KnowledgeHubCard.vue';
...
const fetchBlogs = async () => {
    axios.get('/blogs', { params: { page: currentPage.value,knowledge:1, per_page: perPage.value , filter: formData.value} }).then((response) => {
