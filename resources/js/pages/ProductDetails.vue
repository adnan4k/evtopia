                ...
                <div class="flex flex-wrap lg:flex-nowrap gap-4 mt-6">
                    ...
                    <div class="">
                        ...
                        <!-- Rating  review, sold and share -->
                            ...
                            <!-- <div v-if="product?.mileage" class="h-3 w-[0px] border border-slate-300"></div> -->
                        ...
                        <!-- <div class="py-5 mt-4 flex flex-wrap justify-start items-center gap-4 border-t border-slate-200">

                            <div v-if="product.transmission" class="text-slate-800 text-base font-bold">
                                {{ product.transmission }}
                            </div>


                            <div v-if="product.transmission" class="w-[1px] h-4 bg-slate-400"></div>

                            <div v-if="product.drive_train" class="text-slate-800 text-base font-bold leading-normal">
                                {{ product.drive_train }}
                            </div>

                            <div v-if="product.drive_train" class="w-[1px] h-4 bg-slate-400"></div>


                             <div v-if="product.year" class="text-slate-900 text-base font-bold leading-normal">
                                {{ product.year }}
                            </div>

                            <div v-if="product.year" class="w-[1px] h-4 bg-slate-400"></div>


                             <div v-if="product.mileage" class="text-slate-800 text-base font-bold leading-normal">
                                {{ product.mileage }} KM
                            </div>
