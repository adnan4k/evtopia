...
class PaymentGatewayController extends Controller
{
    ...
    public function chapa_callback($reference){

        $getWay = new ChapaService();
        $getWay->chapaCallback($reference);
    }


    public function chapaPaymentVerification($reference, Request $request){
        $gateway = new ChapaService();
        $response = $gateway->chapaCallback($reference);
    ...
    public function chapa_success( Request $request)
    {

        \Log::info("Payment Request Dump : " . $request);
