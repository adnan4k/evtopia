...
class OrderController extends Controller
{
    ...
    public function bookingDownloadInvoice($id)
    {
        $order = Booking::with(['bookingItems.service'])->findOrFail($id);

        $orderCode = '#'.$order->prefix.$order->booking_code;
        ...
        $pdf = Pdf::loadView('PDF.booking', compact('order', 'qrCodeImage'));

        return $pdf->download('booking-'.$order->prefix.$order->order_code.'.pdf');
    }
