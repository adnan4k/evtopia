...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $driveTrains = DriveTrain::isActive()->get();
        $transmissions = CarTransmission::isActive()->get();

        return view('shop.product.create', compact('brands', 'colors', 'driveTrains', 'transmissions' ,'categories', 'units', 'sizes'));
    }
