...
class NotificationController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->json('nitifications12', [
    ...
    public function show()
    {
        ...
        $notifications = NotificationRepository::query()->whereNull('shop_id')->whereNull('user_id')->orderBy('is_read', 'asc')->latest('id')->paginate(10);
