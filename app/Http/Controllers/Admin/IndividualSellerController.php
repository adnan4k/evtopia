...
class IndividualSellerController extends Controller
{
    ...
    public function index()
    {
        ...
        $users = User::where('is_individual', 1)
        ->with('shop') 
        ->paginate(20); 

        return view('admin.individual_sellers.index', compact('users'));
    }
    ...
    {
        return view('admin.individual_sellers.create');
    }
    ...
    public function store(ShopCreateRequest $request)
    {
        ...
        return to_route('admin.individual_sellers.index')->withSuccess(__('Shop created successfully'));
    }
    ...
    public function show(Shop $shop)
    {
        ...
        return view('admin.individual_sellers.show', compact('shop'));
    }
    ...
    {
        return view('admin.individual_sellers.edit', compact('shop'));
    }
    ...
    public function update(ShopCreateRequest $request, Shop $shop)
    {
        ...
        return to_route('admin.individual_sellers.index')->withSuccess(__('Shop updated successfully'));
    }
    ...
    {
        $orders = $shop->orders()->paginate(10);

        return view('admin.individual_sellers.orders', compact('shop', 'orders'));
    }
    ...
    public function products(Shop $shop)
    {
        ...
        return view('admin.individual_sellers.products', compact('shop', 'products'));
    }
    ...
    {
        $categories = $shop->categories()->paginate(10);

        return view('admin.individual_sellers.category', compact('shop', 'categories'));
    }
    ...
    {
        $reviews = $shop->reviews()->withoutGlobalScopes()->latest('id')->paginate(10);

        return view('admin.individual_sellers.reviews', compact('shop', 'reviews'));
    }
