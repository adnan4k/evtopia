    ...
    public function pdfFiles()
{
    ...
    {
        return $this->belongsTo(DriveTrain::class, 'drive_train_id');
    }
    ...
    public function scopeIsSpecial(Builder $builder)
    {
        return $builder->where('is_special', true)->where('is_approve', true)->whereHas('shop', function ($query) {
            return $query->whereHas('user', function ($query) {
