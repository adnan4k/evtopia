...
class GeneraleSetting extends Model
{
    ...
    public function logo(): Attribute
    {
        ...
        if ($this->mediaLogo && $this->mediaLogo->src) {
    ...
    public function appLogo(): Attribute
    {
        ...
        if ($this->mediaAppLogo && $this->mediaAppLogo->src) {
    ...
    public function favicon(): Attribute
    {
        ...
        if ($this->mediaFavicon && $this->mediaFavicon->src) {
    ...
    public function footerLogo(): Attribute
    {
        ...
        if ($this->mediaFooterLogo && $this->mediaFooterLogo->src) {
    ...
    {
        $qr = null;
        if ($this->mediaFooterQr && $this->mediaFooterQr->src) {
