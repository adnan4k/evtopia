...
Route::controller(AuthController::class)->group(function () {
    ...
    Route::get('/become_a_seller', 'become_a_seller');
});
...
Route::controller(PaymentGatewayController::class)->group(function () {
    ...
    Route::post('chapa_callback/{reference}', 'chapa_callback')->name('payment.chapa_callback');

    Route::get('chapa_payment_verification/{reference}', 'chapaPaymentVerification')->name('chapa_payment_verification');
    ...
    //success and cancel routes for callback
    Route::post('/verify_payment/{reference}', 'chapa_success')->name('chapa_payment.success');
