...
use App\Http\Controllers\Admin\IndividualSellerController;
...
Route::name('admin.')->group(function () {
    ...
    Route::middleware(['auth', 'checkPermission'])->group(function () {
        ...
        Route::controller(ServiceCategoryController::class)->group(function () {
            Route::get('/service-categories', 'index')->name('serviceCategory.index');
            Route::get('/service-category/create', 'create')->name('serviceCategory.create');
            Route::post('/service-category/store', 'store')->name('serviceCategory.store');
            Route::get('/service-category/{serviceCategory}/edit', 'edit')->name('serviceCategory.edit');
            Route::put('/service-category/{serviceCategory}/update', 'update')->name('serviceCategory.update');
            Route::get('/service-category/{serviceCategory}/toggle', 'statusToggle')->name('serviceCategory.toggle');
            Route::get('/service-category/{serviceCategory}/destroy', 'destroy')->name('serviceCategory.destroy');
        });
        ...
        Route::controller(ServiceController::class)->group(function () {
            ...
            Route::get('/service/{service}/edit', 'edit')->name('service.edit');
            Route::put('/service/{service}/update', 'update')->name('service.update');
            Route::get('/service/{service}/toggle', 'statusToggle')->name('service.toggle');
            Route::get('/service/{service}/destroy', 'destroy')->name('service.destroy');
        });
        ...
        Route::controller(BookingController::class)->group(function () {
            ...
            Route::get('/booking/{booking}/show', 'show')->name('booking.show');
            Route::put('/booking/{booking}/update-status', 'updateStatus')->name('booking.updateStatus');
            Route::get('/booking/{booking}/destroy', 'destroy')->name('booking.destroy');
        });
        ...
        Route::controller(ShopController::class)->group(function () {
            ...
            Route::post('/shops/{shop}/reset-password', 'resetPassword')->name('shop.reset.password');
             ...
             // Shops
             Route::controller(IndividualSellerController::class)->group(function () {
                Route::get('/individual_sellers', 'index')->name('individual.index');
                Route::get('/individual_sellers/create', 'create')->name('individual.create');
                Route::post('/individual_sellers/store', 'store')->name('individual.store');
                Route::get('/individual_sellers/{shop}/edit', 'edit')->name('individual.edit');
                Route::post('/individual_sellers/{shop}/update', 'update')->name('individual.update');
                Route::get('/individual_sellers/{shop}', 'show')->name('individual.show');
                Route::get('/individual_sellers/{shop}/status-toggle', 'statusToggle')->name('individual.status.toggle');
                Route::get('/individual_sellers/{shop}/orders', 'orders')->name('individual.orders');
                Route::get('/individual_sellers/{shop}/products', 'products')->name('individual.products');
                Route::get('/individual_sellers/{shop}/categories', 'categories')->name('individual.category');
                Route::get('/individual_sellers/{shop}/reviews', 'reviews')->name('individual.reviews');
                Route::post('/individual_sellers/{shop}/reset-password', 'resetPassword')->name('individual.reset.password');
            });
        ...
        Route::controller(BookingController::class)->group(function () {
            Route::get('/bookings', 'index')->name('booking.index');
            Route::get('/booking/{booking}/show', 'show')->name('booking.show');
            Route::get('/booking/{booking}/status-change', 'statusChange')->name('booking.status.change');
            Route::get('/booking/{booking}/payment-status-toggle', 'paymentStatusToggle')->name('booking.payment.status.toggle');
        });
        ...
        Route::get('posts/{post}/comments/{comment}/status', [PostController::class, 'updateCommentStatus'])->name('posts.comment.status');
        Route::get('posts/{post}/comments/{comment}/delete', [PostController::class, 'deleteComment'])->name('posts.comment.delete');
        
        Route::resource('post_categories', PostCategoryController::class);
        Route::get('/posts/{id}/comment', [PostController::class, 'comment'])->name('posts.comment');
        Route::get('/posts/{post}/toggle', [PostController::class, 'statusToggle'])->name('posts.toggle');
        Route::get('/post_categories/{category}/toggle', [PostCategoryController::class, 'statusToggle'])->name('post_categories.toggle');
        Route::get('/post_categories/{category}/delete', [PostCategoryController::class, 'destroy'])->name('post_categories.delete');
        Route::get('/post_tags/{category}/delete', [PostTagController::class, 'destroy'])->name('post_tags.delete');
        Route::get('/posts/{category}/delete', [PostController::class, 'destroy'])->name('posts.delete');
