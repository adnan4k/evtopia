...
Route::controller(NotificationController::class)->group(function () {
    Route::get('/new-notifications', 'index');
    Route::get('/mobile-notifications', 'index_mobile');
    Route::get('/count_notification', 'totalNotification');
    Route::get('/notifications', 'show');
    Route::get('/disable_notification/{id}', 'disable_notification');
    Route::get('/notification/{notification}/read', 'markAsRead');
    Route::get('/notification/{notification}/destroy', 'destroy');
    Route::get('/notification/read-all', 'markAllAsRead');
});
// country route
...
Route::controller(ProductController::class)->group(function () {
    ...
    Route::get('/special-products', 'special');
...
Route::controller(ServiceController::class)->group(function () {
    ...
    Route::get('/service-details', 'show');
});
...
Route::middleware(['auth:sanctum','validate.token'])->group(function () {
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::get('/verify_payment', 'verify_payment');
        Route::get('/booking-details', 'booking_details');
    ...
    Route::controller(CartController::class)->group(function () {
        ...
        Route::get('/service-carts', 'service_carts');
        Route::post('/cart/store', 'store');
        Route::post('/service-cart/store', 'service_store');
        Route::post('/cart/increment', 'increment');
        Route::post('/cart/decrement', 'decrement');
        Route::post('/cart/delete', 'destroy');
        Route::post('/service-cart/delete', 'service_destroy');
        Route::post('/cart/checkout', 'checkout');
        Route::get('/service-cart/checkout', 'service_checkout');
    });
