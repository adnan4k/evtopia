...
use App\Http\Controllers\Shop\CarTransmissionController;
use App\Http\Controllers\Shop\DriveTrainController;
...
Route::name('shop.')->group(function () {
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::get('/booking-download-invoice/{id}', 'bookingDownloadInvoice')->name('booking-download-invoice');
    });
    ...
    Route::controller(LoginController::class)->group(function () {
        ...
        Route::get(('/individual'), 'create_individual')->name('register_individual');
        Route::get(('/register'), 'create')->name('register');
        Route::post(('/individual'), 'store_individual')->name('register_individual.submit');
    ...
    Route::middleware(['authShop', 'checkPermission'])->group(function () {
        ...
        Route::controller(UnitController::class)->group(function () {
           ...
           //unit
           Route::controller(CarTransmissionController::class)->group(function () {
            Route::get('/transmissions', 'index')->name('transmission.index');
            Route::post('/transmission/store', 'store')->name('transmission.store');
            Route::put('/transmission/{transmission}/update', 'update')->name('transmission.update');
            Route::get('/transmission/{transmission}/destroy', 'destroy')->name('transmission.destroy');
            Route::get('/transmission/{transmission}/toogle', 'statusToggle')->name('transmission.toggle');
        });

           //unit
           Route::controller(DriveTrainController::class)->group(function () {
            Route::get('/drive_trains', 'index')->name('drive_train.index');
            Route::post('/drive_train/store', 'store')->name('drive_train.store');
            Route::put('/drive_train/{id}/update', 'update')->name('drive_train.update');
            Route::get('/drive_train/{id}/destroy', 'destroy')->name('drive_train.destroy');
            Route::get('/drive_train/{id}/toogle', 'statusToggle')->name('drive_train.toggle');
        });
